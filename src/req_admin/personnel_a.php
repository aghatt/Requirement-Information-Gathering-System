...
<input style="margin-right: 20px;" type="button" onclick="location.href='osr.php';" value="Office Staff Requirements"/>
<input style="margin-right: 20px;" type="button" onclick="location.href='ar.php';" value="Additional Requirements"/>
