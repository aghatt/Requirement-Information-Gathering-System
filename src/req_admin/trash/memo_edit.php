...
<table cellpadding="10px" cellspacing="10px" border="2" >
	...
	<tr><th colspan="4">Edit Memorandum</th></tr>
		...
		<tr>
			<th>Purpose</th>
			<td colspan="3"><textarea name="purpose" rows="4" cols="50" value='<?php echo $row['purpose'];?>'><?php echo $row['purpose'];?></textarea></td>
		</tr>
		<tr>
...
//echo $dt[2];
			...
			<tr>	
				<td >
					<select required name="dd" >
						<option value='<?php echo $dt[0];?>'><?php echo $dt[0];?></option>
				...
				<td>
					<select required name="mm">
						<option value='<?php echo $dt[1];?>'><?php echo $mon;?></option>
		...
		<tr>
			...
			<td colspan="3"><textarea name="outcome" rows="4" cols="50" ><?php echo $row['outcome'];?></textarea></td>
		</tr>
		<tr>
			<td colspan="4">
