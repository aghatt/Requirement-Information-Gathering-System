...
<div style="color:blue; margin-bottom:10px; font-size:20px;padding-top: 10px;"> <b>Academic Affairs</b> </div>


    <br>                                
                                                                       
<center>
<input style="margin-right: 10px;" type="button" onclick="location.href='memo_next.php';" value="MoU"/>
   </center>     
<a href="homepage.php" style="color:blue; text-decoration:none;font-size: 18px; float: right;margin-right:20px; margin-top: 150px;"><< <b>Back to Home</b></a>
