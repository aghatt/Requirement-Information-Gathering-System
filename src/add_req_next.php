...
<div style="color:blue; margin-bottom:10px; font-size:20px;padding-top: 10px;"> <b>Other Staff</b> </div>


    <br>                                
 <div>                                                                      

<input style="margin-right: 10px;" type="button" onclick="location.href='add_req_original.php';" value="Add Requirements"/>
<input style="margin-right: 10px;" type="button" onclick="location.href='view_add_req.php';" value="View Requirements"/>
  </div>
